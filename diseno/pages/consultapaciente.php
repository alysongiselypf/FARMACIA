...
<header>
    ...
    <div class="page-content-resultados">
        <h1>Mis Resultados Médicos</h1>

        <?php if (count($misConsultas) > 0): ?>
            <?php foreach ($misConsultas as $consulta): ?>
                <div class="consulta-card">
                    <div class="consulta-fecha">
                        <?php echo date('d \d\e F, Y', strtotime($consulta['fecha_consulta'])); ?>
                    </div>
                    <div class="consulta-doctor">
                        Dr(a). <?php echo htmlspecialchars($consulta['nombres'] . ' ' . $consulta['apellidos']); ?>
                    </div>
                    <div class="consulta-especialidad">
                        <?php echo htmlspecialchars($consulta['especialidad'] ?? ''); ?>
                    </div>

                    <div class="consulta-detalle">
                        <label>Motivo de consulta</label>
                        <p><?php echo htmlspecialchars($consulta['motivo'] ?: 'No especificado'); ?></p>
                    </div>
        ...
        <?php else: ?>
            <div class="sin-resultados">
                <p>Aún no tienes consultas médicas registradas.</p>
            </div>
        <?php endif; ?>

...
<head>
  <meta charset="UTF-8">
  <title>Agregar Medicamento - UCSP Farmacia</title>
...
<body>
  ...
  <div class="card-admin">
    ...
    <form method="POST" action="../../php/procesar_agregar_producto.php" enctype="multipart/form-data">
      <input type="hidden" name="tipo" value="medicamento">

      <div class="campo">
        <label for="nombre">Nombre del medicamento</label>
        <input type="text" name="nombre" id="nombre" placeholder="Ej. Paracetamol" required>
      </div>

      <div class="campo">
        <label for="clase">Clase</label>
        <input type="text" name="clase" id="clase" placeholder="Ej. Analgésico" required>
      </div>
      ...
      <div class="campo">
        ...
        <input type="number" name="precio" id="precio" step="0.01" min="0" placeholder="Ej. 10.50" required>
      </div>
